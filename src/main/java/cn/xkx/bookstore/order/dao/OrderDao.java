...
public class OrderDao {
     ...
     * 获取所有订单ID
     */
    public List<String> getAllOrderoid() {
    ...
    public List<Salesituation> getAllorderTimeAndDate(){
        List<Salesituation> salesituations = new ArrayList<Salesituation>();
        String sql = "select ordertime,total from orders";
        Object[] params = {};
        try {
            salesituations = qr.query(sql, new BeanListHandler<Salesituation>(Salesituation.class), params);
        } catch (SQLException e) {
            e.printStackTrace();
        }
